...
The same situation happens when the right arrow reaches to the end of the scroll. */

const mainBody = document.querySelector(".scroll-view");
...
// Checking the status of the left arrow button. If the scroll reached to end, button hides.
...
// Loading the data for UI components
loadPlotData();

// Listening is there any click on the right button
arrowRight.addEventListener("click", function () {
  mainBody.scrollBy(1200, 0);
  rightArrowStatus();
});

// Listening is there any click on the left button
